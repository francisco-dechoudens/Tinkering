...
- (id)initWithXMLElement:(TBXMLElement *)element parent:(KMLElement *)parent
{
    ...
    if (self) {
        ...
        _weight = [self textForSingleChildElementNamed:@"weight" xmlElement:element];
        _src = [self textForSingleChildElementNamed:@"src" xmlElement:element];
        _dest = [self textForSingleChildElementNamed:@"dest" xmlElement:element];
