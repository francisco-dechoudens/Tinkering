...
-(NSArray*)getVertexes{
    ...
    NSArray *vertexes = [_document.firstChild childrenNamed:@"Vertexes"];
    
    // Array of objects that we are returning
    NSMutableArray *result = [[NSMutableArray alloc] init];
    
    for (SMXMLElement *aVertexes in vertexes) {
        for (SMXMLElement *vertex in [aVertexes childrenNamed:@"vertex"]) {
